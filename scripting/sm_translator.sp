...
public void OnPluginStart()
{
	...
	// 将该行调整为LogType_Debug可以在log中获得更多信息，但是你的api key等敏感数据也会记录！
    ...
    g_hTranslateApi = CreateConVar("sm_translator_api", "0", "SM Translator Api, 0=Disable, 1=Baidu, 2=DeepL api free 3=DeepL api pro");
    g_hTranslateApiKey = CreateConVar("sm_translator_apikey", "none", "SM Translator Apikey, for baidu api");
    g_hTranslateApiAuth = CreateConVar("sm_translator_apiauth", "none", "SM Translator Apikey, for baidu api and deepl (':fx' is not required)");
